...
_lazy_exports = {
    ...
    "remember_event": (".core.memory", "remember_event"),
    "remember_turn": (".core.memory", "remember_turn"),
    "retry_pending_ingest": (".core.memory", "retry_pending_ingest"),
    "ingest_status": (".core.memory", "ingest_status"),
    "recall_bounded": (".core.memory", "recall_bounded"),
    "dream_plan": (".core.memory", "dream_plan"),
    "dream_submit_receipt": (".core.memory", "dream_submit_receipt"),
    "dream_apply": (".core.memory", "dream_apply"),
    "dream_resume": (".core.memory", "dream_resume"),
    "dream_undo": (".core.memory", "dream_undo"),
    "dream_status": (".core.memory", "dream_status"),
