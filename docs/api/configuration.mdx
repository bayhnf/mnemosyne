...
| `dream_active` | `MNEMOSYNE_DREAM_ACTIVE` | `false` | no | Dream lifecycle gate. Set before verified apply/undo, cleared on completion; while active, sleep-time model-refresh auto-apply is forced off. |
